        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <form method="post" action="?m=matkul_tambah">
                        <div class="card-body">
                             ...
                             <div class="form-group">
                               <label>Kode Matkul <span class="text-danger">*</span></label>
                               <input class="form-control" type="text" name="kode" autocomplete="off" value="<?=addslashes($_POST["kode"])?>"/>
                            </div>

                            <div class="form-group">
                               <label>Nama Matkul <span class="text-danger">*</span></label>
                               <input class="form-control" type="text" name="nama" autocomplete="off" value="<?=addslashes($_POST["nama"])?>"/>
                            </div>

                            <div class="form-group">
                                <label>SKS</label>
                                <input class="form-control" type="text" name="sks" autocomplete="off" value="<?=addslashes($_POST["sks"])?>"/>
                            </div>

                            <div class="form-group">
                                <label>Semester</label>
                                <select class="form-control" name="kode_semester">
                                        <option value=""></option>
                                        <?=AG_get_semester_option($_POST[kode_semester])?>
                                    </select>
                            </div>

                            <div class="card-footer">
                                 <button class="btn btn-primary"><i class="fa fa-save"></i> Simpan</button>
                                    <a class="btn btn-danger" href="?m=matkul"><i class="fa fa-arrow-left"></i> Kembali</a>
                            </div>
                        </div>                
                    </form>
                </div>
